...
if(!isset($_POST["email"]) || !isset($_POST["selected_username"]) || !isset($_POST["timestamp"])){
	exit;
}
$getUserData = doLogin($_POST["email"]);
doesUsernameMeetRequirements($_POST["selected_username"]);
if(checkIfEmailOrUsernameIsInUse($_POST["selected_username"])){
	sendErrorJSONToClient($usernameIsInUseErrorMessage);
}
$token = generateToken();
updateTokenUsingEmail($token, $_POST["email"]);
setUsername($_POST["email"], $_POST["selected_username"]);
...
die(json_encode(array(
    ...
    "username" => $_POST["selected_username"],
    "snaps" => array(
     //   array(
    ...
    "friends" => array(
        array(
            ...
            "name" => strtolower($_POST["selected_username"]),
            "display" => $_POST["selected_username"],
            "type" => 0
      //  ),
      //  array(
     //       "can_see_custom_stories" => true,
